...
def merge_score_dicts(existng :dict,newupdate:dict)->dict:
    if existng is None:
        return newupdate
    return {**existng,**newupdate}
...
sample_scripts=""" Yo guys! Welcome back to the stream. Today I am going to show you how to hack into 
